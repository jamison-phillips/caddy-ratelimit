module github.com/jamison-phillips/caddy-ratelimit
...
require (
	...
	github.com/antlr/antlr4 v0.0.0-20220418222510-f25a4f6275ed //v0.0.0-20200503195918-621b933c7a7f // indirect
